...
/**
 * In order to code OpenCL, i need to learn openCL. figured this is as good a place as any to put my tests
 *
 * @author DaPorkchop_
 */
public class OpenCLTests {
    ...
    public void test1() {
        ...
        cl_program program = clCreateProgramWithSource(context,
                1, new String[]{new Scanner(OpenCLTests.class.getResourceAsStream("/test1.cl"), "UTF-8").useDelimiter("\\A").next()}, null, null);
